...
app.post("/", async (req, res) => {
  ...
  if (req.body.participants !== "") params.append("participants" , req.body.participants);
  console.log(params.toString());



  try {
    const ulfix =  `${URL}filter?${params.toString()}`;
    console.log(ulfix);
    const response = await axios.get(`${URL}filter?${params.toString()}`);
